              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="header-text">
                    ...
                    <h6 style="padding-top: 18px"><a href="?page=komik/tambah">Tambah Data Komik</a></h6>
                              ...
                              <thead>
                                ...
                                while($item = mysqli_fetch_array($komik)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a href="?page=komik/detail_komik&id_komik=<?= $item['id_komik']; ?>" class="btn btn-success">Gambar</a> 
                                        </td>                                  
