                ...
                <?php
                  ...
                  <div class="col-lg-3">
                    <div class="item">
                      ...
                      ?> 
                          <div class="icon">
                              <a href="?page=paket/bayar&id_paket=<?php echo $data["id_paket"];?>"><img src="assets/images/logo2.jpg" alt="" style="max-width: 60px; border-radius: 50%" /></a>
                          </div>
                          <h4><a href="?page=paket/bayar&id_paket=<?php echo $data["id_paket"];?>"><?= $data['nama_paket']?></a></h4>
                      <?php else: ?>
                          <div class="icon">
